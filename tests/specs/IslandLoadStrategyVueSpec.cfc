/**
 * Spec: <cf_Island framework={Vue} strategy="load"> (SSR + immediate hydration)
 *
 ...
 *
 * Like the client spec, this is hermetic: a mock Vue-shaped framework struct
 * stands in for the real renderer so we don't depend on the SSR sidecar.
 * React parity for this contract lives in IslandLoadStrategyReactSpec.cfc.
 */
component extends="testbox.system.BaseSpec" {
	...
	function run(){
		...
		describe( "cf_Island strategy=load (Vue)", function(){
